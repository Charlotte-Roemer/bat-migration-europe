...
Sp = "Nyclei"
THETA = 0.1
nb <- 10000 # number of pairs of origin-goal points
...
for (k in 1:2) {
  ...
  # Save result
  writeRaster(oper, paste0("/mnt/beegfs/croemer/VigieChiro/Connectivity_maps/", 
                                             Name, "_", Sp, "_", Season, "_", THETA, ".tif"), overwrite=TRUE)
