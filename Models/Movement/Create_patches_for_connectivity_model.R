...
for(i in 1:length(list_species)){
  ...
  if(!AggregatedPixel){
    ...
    Raster_0715= Q80_function(Rasterize_function(dataa_0715))
    Raster_0801= Q80_function(Rasterize_function(dataa_0801))
    Raster_0815= Q80_function(Rasterize_function(dataa_0815))
    Raster_0901= Q80_function(Rasterize_function(dataa_0901))
    Raster_0915= Q80_function(Rasterize_function(dataa_0915))
    Raster_1001= Q80_function(Rasterize_function(dataa_1001))
    Raster_1015= Q80_function(Rasterize_function(dataa_1015))
