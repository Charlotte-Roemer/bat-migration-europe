...
if (What == 1){
  EPA="scripts_VC/extr_PF_DataLP.R"
  ...
  EPA="C:/Users/croemer01/Documents/R/bat-migration-europe/Brouillons/Create_dataset_with_weight_on_proba/extr_PF_ActNuit_BMRE.R" # Script counting number of bat passes/night
}
...
args[10]="mnt/VigieChiro/Raw" # where raw files are stored
args[12]=""
args[13]=""
args[14]=""
...
if (RandomResample){
  Pattern=basename(paste0(args[10],"/SpNuit2_DI__","weighted_DataLP_PF_export"))
  ...
  fwrite(ActTot,paste0(args[10],"/SpNuit2_DI_","weighted_DataLP_PF_exportTot.csv"))
}else{
  ...
  ActTot=rbindlist(my.data)
  fwrite(ActTot,paste0(args[10],"/SpNuit2_DI_",args[3],"_DataLP_PF_exportTot.csv")) 
}
