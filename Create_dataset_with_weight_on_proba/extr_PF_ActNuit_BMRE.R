...
if(!exists("FRaw"))
{
  ...
  args[10]="C:/Users/croemer01/Documents/Donnees vigie-chiro/" #output dir
  args[14]=""
  args[12]=""
  args[13]=""
...
# Read species list
SpeciesList=fread("C:/Users/croemer01/Documents/Donnees vigie-chiro/SpeciesList.csv")
...
if(nrow(DataLP)>0)
{
  ...
  if(nrow(DataLPS)>0)
  {
    ...
    {
      if(RandomResample){
        fwrite(DataFiable,paste0(args[10],"/weighted_",basename(args[4])))
      }else{
  ...
  #### STEP 2 - Aggregate number of bat passes/night ####
    ...
    if(args[17]){ #compute checked confidences
      ...
      NameFile=paste0(args[10],"/SpNuit2Valid_",PrefDoubt,Filter,TimeFilterL,"_"
                      ,TimeFilterH,"_",args[3],"_",basename(args[4]))
      
    }else{
      if(RandomResample){
        NameFile=paste0(args[10],"/SpNuit2_",PrefDoubt,Filter,TimeFilterL,"_"
